  ...
  return (
    <div ref={ref} className="p-12 hidden print:block text-slate-900 bg-white font-sans max-w-[800px] mx-auto">
      ...
      <div className="mt-12 pt-6 border-t border-slate-200 text-center text-sm text-slate-500">
        Generated by Equalyze AI Governance Platform • Verification ID: {sys.id.split('-')[0].toUpperCase()}
      </div>
    </div>
  );
});
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans flex flex-col">
      <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-10 flex items-center px-4 sm:px-6 lg:px-8 shadow-sm">
        <div className="flex items-center gap-2 flex-1">
          ...
          <span className="font-bold tracking-tight text-slate-900 dark:text-white text-lg">Equalyze Public Registry</span>
        </div>
